...
public class TelaCPN extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        if (jTable1.getColumnModel().getColumnCount() > 0) {
            ...
            jTable1.getColumnModel().getColumn(0).setPreferredWidth(49);
            jTable1.getColumnModel().getColumn(0).setMaxWidth(52);
            jTable1.getColumnModel().getColumn(1).setMinWidth(39);
            jTable1.getColumnModel().getColumn(1).setPreferredWidth(40);
            jTable1.getColumnModel().getColumn(1).setMaxWidth(43);
        ...
        jLabel1.setText("CENTRO DE PARTO NORMAL");
